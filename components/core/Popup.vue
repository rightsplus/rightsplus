<template>
  ...
  <Transition name="fade">
    ...
    >
      <div
        class="bg-white rounded-2xl shadow-2xl w-[640px] max-w-screen min-h-[160px] max-h-[90vh] overflow-auto flex flex-col justify-between m-5 relative"
        v-bind="$attrs"
      >
        <div class="flex justify-between gap-12 w-full" v-if="$attrs.onClose || title">
