import type { FlightAviationEdge } from "~/aviation-edge.types";
import type { Flight, RowFlight } from "~/types";
...
export const transformAviationStackFlight = (aviationEdgeFlight: FlightAviationEdge): Flight => {
	const airline: Flight['airline'] = {
		name: aviationEdgeFlight.airline.name,
		iata: aviationEdgeFlight.airline.iataCode.toUpperCase(),
	};
